...
| Conventions | File naming, dates, links, inferred, tension, context, gaps, supersession, entity tags | Stable |
| Writing Style | Six qualities (lightness, quickness, exactitude, visibility, multiplicity, consistency) | Stable |
| Human Notes | `notes/` free-form space; `## Human Context` in component docs; agent reads but never writes | Stable |
